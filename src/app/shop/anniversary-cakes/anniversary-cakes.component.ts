...
@Component({
  ...
  styleUrls: ['./anniversary-cakes.component.css']
})
export class AnniversaryCakesComponent implements OnInit{
...
for (var i:any = 0; i < btns.length; i++) {
  ...
  getData() {
    this.http.get<Product[]>('https://sweetartcakes-be-production.up.railway.app/anniversaryCakes/').subscribe(response => {
