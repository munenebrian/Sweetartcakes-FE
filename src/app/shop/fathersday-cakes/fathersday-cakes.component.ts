...
@Component({
  selector: 'app-fathersday-cakes',
  templateUrl: './fathersday-cakes.component.html',
  styleUrls: ['./fathersday-cakes.component.css']
})
export class FathersdayCakesComponent implements OnInit{
