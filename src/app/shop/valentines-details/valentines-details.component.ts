...
@Component({
  selector: 'app-valentines-details',
  templateUrl: './valentines-details.component.html',
  styleUrls: ['./valentines-details.component.css']
})
export class ValentinesDetailsComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    this.route.params.subscribe(
      data =>{
        this.id = data['id'];
        console.log(this.id);
        this.ocassionalcakedetailsService.getValentinesCakeDetails(this.id).subscribe(
          datax =>{
