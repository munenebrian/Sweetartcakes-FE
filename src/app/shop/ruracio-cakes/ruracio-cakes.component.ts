...
@Component({
  selector: 'app-ruracio-cakes',
  templateUrl: './ruracio-cakes.component.html',
  styleUrls: ['./ruracio-cakes.component.css']
})
export class RuracioCakesComponent implements OnInit{
