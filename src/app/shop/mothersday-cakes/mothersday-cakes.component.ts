...
@Component({
  selector: 'app-mothersday-cakes',
  templateUrl: './mothersday-cakes.component.html',
  styleUrls: ['./mothersday-cakes.component.css']
})
export class MothersdayCakesComponent implements OnInit{
