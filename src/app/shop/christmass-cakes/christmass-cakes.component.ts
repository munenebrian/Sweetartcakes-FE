...
@Component({
  selector: 'app-christmass-cakes',
  templateUrl: './christmass-cakes.component.html',
  styleUrls: ['./christmass-cakes.component.css']
})
export class ChristmassCakesComponent implements OnInit{
