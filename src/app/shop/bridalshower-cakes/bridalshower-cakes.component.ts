...
@Component({
  selector: 'app-bridalshower-cakes',
  templateUrl: './bridalshower-cakes.component.html',
  styleUrls: ['./bridalshower-cakes.component.css']
})
export class BridalshowerCakesComponent implements OnInit{
