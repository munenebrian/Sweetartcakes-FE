...
@Component({
  selector: 'app-easter-cakes',
  templateUrl: './easter-cakes.component.html',
  styleUrls: ['./easter-cakes.component.css']
})
export class EasterCakesComponent implements OnInit{
