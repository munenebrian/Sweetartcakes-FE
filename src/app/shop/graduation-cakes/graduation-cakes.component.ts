...
@Component({
  selector: 'app-graduation-cakes',
  templateUrl: './graduation-cakes.component.html',
  styleUrls: ['./graduation-cakes.component.css']
})
export class GraduationCakesComponent implements OnInit{
