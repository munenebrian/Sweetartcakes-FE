...
@Component({
  selector: 'app-christening-cakes',
  templateUrl: './christening-cakes.component.html',
  styleUrls: ['./christening-cakes.component.css']
})
export class ChristeningCakesComponent implements OnInit{
