...
@Component({
  selector: 'app-baptismal-cakes',
  templateUrl: './baptismal-cakes.component.html',
  styleUrls: ['./baptismal-cakes.component.css']
})
export class BaptismalCakesComponent implements OnInit{
