...
@Component({
  selector: 'app-home-anniversary',
  templateUrl: './home-anniversary.component.html',
  styleUrls: ['./home-anniversary.component.css']
})
export class HomeAnniversaryComponent implements OnInit{
  ...
  ngOnInit(): void {
    this.homeWeddingService.getFiveAnniversaryCakes().subscribe(products => {
