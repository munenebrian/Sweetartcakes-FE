...
@Component({
  selector: 'app-home-wedding',
  templateUrl: './home-wedding.component.html',
  styleUrls: ['./home-wedding.component.css']
})
export class HomeWeddingComponent implements OnInit{
  ...
  ngOnInit(): void {
    this.homeWeddingService.getFiveWeddingCakes().subscribe(products => {
